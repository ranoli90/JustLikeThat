    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      {showCreateForm && (
        <div className="mb-6 rounded-lg bg-white p-4 shadow">
          <h2 className="mb-4 text-lg font-semibold">Create Remediation Action</h2>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select className="w-full rounded border p-2" id="triggerType">
              ...
              <div>
                ...
                <select className="w-full rounded border p-2" id="actionType">
      ...
      <div className="mb-6 rounded-lg bg-white p-4 shadow">
        <h2 className="mb-4 text-lg font-semibold">Active Remediation Actions</h2>
        {loading ? (
          <div className="py-4 text-center">Loading...</div>
        ) : (
          <div className="space-y-2">
            {actions.map((action) => (
              <div key={action.id} className="rounded-lg border p-4 hover:bg-gray-50">
      ...
      {/* Predefined Actions */}
      <div className="mb-6 rounded-lg bg-white p-4 shadow">
        <h2 className="mb-4 text-lg font-semibold">Predefined Remediation Actions</h2>
        <div className="grid grid-cols-2 gap-4">
          {predefined.map((action) => (
            <div key={action.name} className="rounded-lg border p-4">
              <div className="font-semibold">{action.name}</div>
              <div className="mt-1 text-sm text-gray-500">{action.description}</div>
